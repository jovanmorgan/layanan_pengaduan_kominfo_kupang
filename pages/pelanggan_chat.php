...
<head>
    ...
    <title>
        Home Pelanggan | Layanan Pengaduan Kominfo
    </title>
    <!--     Fonts and icons     -->
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link active" href="../pages/pelanggan_chat">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Chat</h6>
                </nav>
                    ...
                    <div class="card overflow-auto">
                        ...
                        <div class="card-body pt-4 p-3">
                            <ul class="list-group">
                                ...
                                // Query untuk mengambil data dari tabel topik_chat sesuai dengan id_pelanggan dari sesi
                                ...
                                WHERE topik_chat.id_pelanggan = $id_pelanggan"; // Sesuaikan kondisi WHERE dengan id_pelanggan
    ...
    <script>
        ...
        function tambahChat(id_topik_chat) {
            Swal.fire({
                ...
                html: '<form id="myForm" action="pelanggan/chat/chat.php" method="POST" style="font-size: 16px;">' +
                ...
                if (result.value === 'success') {
                    ...
                    xhrDetailChat.open('GET', 'pelanggan/chat/cek_detail_chat.php?id_topik_chat=' + idTopikChat, true);
                    ...
                    xhrDetailWaktu.open('GET', 'pelanggan/chat/cek_detail_waktu.php?id_topik_chat=' + idTopikChat, true);
        ...
        commentButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('GET', 'pelanggan/chat/cek_detail_chat.php?id_topik_chat=' + idTopikChat, true);
                xhr.onload = function() {
                    if (xhr.status === 200) {
                ...
                xhrWaktu.open('GET', 'pelanggan/chat/cek_detail_waktu.php?id_topik_chat=' + idTopikChat, true);
