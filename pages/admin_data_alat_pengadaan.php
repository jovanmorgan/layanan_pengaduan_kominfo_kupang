...
<body class="g-sidenav-show   bg-gray-100">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h3 class="text-center">Data Alat Pengadaan</h3>
                            ...
                            <div class="dropdown">
                                ...
                                <!-- Tombol alat_export -->
                                <a href="admin/alat_tambah/alat_export" target="_blank" class="btn btn-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                    EXPORT
                                </a>
                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                                Nama Alat</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                                Dinas Yang Membutuhkan Alat</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                                Kendala</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                                Waktu</th>
    ...
    <script>
        ...
        function KirimPesan(id_admin, id_alat, id_pengaduan) {
            Swal.fire({
                    title: 'Kirim Pesan?',
                    text: 'Beri Tahu pelanggan Kendalah yang terjadi!',
                    icon: 'info',
                    html: '<form id="myForm" action="admin/alat_tambah/kirim_pesan.php" method="POST" style="font-size: 16px;">' +
                ...
                .then((result) => {
                    if (result.value === 'success') {
                        Swal.fire('Berhasil!', 'Pesan Berhasil Terkirim Kepelanggan', 'success').then(() => {
