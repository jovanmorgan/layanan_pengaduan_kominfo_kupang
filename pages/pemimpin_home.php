...
<head>
    ...
    <title>
        Home Pemimpin | Layanan Pengaduan Kominfo
    </title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/pemimpin_home">
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <a href="../pages/pemimpin_home" style="text-decoration: none; color: inherit;">
                        <div class="card">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <a href="../pages/pemimpin_profile" style="text-decoration: none; color: inherit;">
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <a href="../pages/pemimpin_laporan" style="text-decoration: none; color: inherit;">
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            // Query SQL untuk menghitung jumlah jenis_pengaduan yang berbeda
                                            $query_count = "SELECT COUNT(DISTINCT jenis_pengaduan) AS total_jenis FROM pengaduan";
                                            $result_count = mysqli_query($koneksi, $query_count);

                                            if ($result_count) {
                                                $row_count = mysqli_fetch_assoc($result_count);
                                                $total_jenis = $row_count['total_jenis'];

                                                echo "<h5 class='font-weight-bolder'>$total_jenis Data</h5>";
                                            } else {
                                    ...
                                    <p class="mb-0 text-sm">
                                        <span class="text-success font-weight-bolder">Laporan Kendala :</span>
                                        data-data Laporan Kendala
                                    </p>
                                </div>
                            </div>
                        </div>
