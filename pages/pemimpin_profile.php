...
<head>
    ...
    <title>
        Profile Pemimpin | Layanan Pengaduan Kominfo
    </title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="../pages/pemimpin_laporan">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/pemimpin_profile">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        // Periksa apakah session id_pemimpin telah diset
        if (isset($_SESSION['id_pemimpin'])) {
            $id_pemimpin = $_SESSION['id_pemimpin'];

            // Query SQL untuk mengambil data admin berdasarkan id_pemimpin dari session
            $query = "SELECT * FROM pemimpin WHERE id_pemimpin = '$id_pemimpin'";
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <form id="editDataProfile" action="pemimpin/fp/data_fp.php" method="POST">
                                                    <input type="hidden" class="form-control" name="id_pemimpin" id="id_pemimpin" value="<?php echo $admin['id_pemimpin']; ?>">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="example-text-input" class="form-control-label">Nama</label>
                                                            <input class="form-control" type="text" name="nama_pemimpin" value="<?php echo $admin['nama_pemimpin']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                ...
                                                <div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
                                                    <a href="javascript:void(0)" onclick="document.getElementById('editFotoProfile').click()">
                                                        <?php if (!empty($admin['gambar'])) : ?>
                                                            <img src="pemimpin/fp/gambar/<?php echo $admin['gambar']; ?>" class="rounded-circle img-fluid border border-2 border-white">
                                                        <?php else : ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('editDataProfile').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'pemimpin/fp/data_fp.php', true);
                xhr.onload = function() {
                    // Sembunyikan elemen .loading setelah permintaan AJAX selesai
                    loding.style.display = 'none';
