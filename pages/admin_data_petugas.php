...
<head>
    ...
    <title>
        Petugas Admin | Layanan Pengaduan Kominfo
    </title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/admin_data_petugas">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-badge text-success text-sm opacity-10"></i>
                        </div>
        ...
        <div class="modal fade" id="modalPetugas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="tambahPetugas" action="admin/petugas/petugas_tambah.php">
        ...
        <div class="modal fade" id="modalEditPetugas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="editPetugas" action="admin/pemimpin/pemimpin_edit.php">
                        <div class="modal-body">
                            <input type="text" class="d-none" name="id_petugas" id="editid_petugas">
                            <!-- Isi form untuk menambah data -->
                            <div class="form-group">
                                <label for="nama_petugas">Nama Petugas</label>
                                <input type="text" class="form-control" name="nama_petugas" id="editnama_petugas" placeholder="Masukkan nama Petugas">
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <div class="dropdown">
                                ...
                                <!-- Tombol tambah -->
                                <button class="btn btn-primary font-weight-bold text-xs" data-toggle="modal" data-target="#modalPetugas">
                                    TAMBAH
                                </button>
                                <!-- Tombol petugas_export -->
                                <a href="admin/petugas/petugas_export" target="_blank" class="btn btn-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                    EXPORT
                                </a>
                            </div>
                            <hr class="horizontal dark">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($search_query)) {
                                            $query .= " WHERE nama_petugas LIKE '%$search_query%' OR alamat LIKE '%$search_query%' OR nomor_telpon LIKE '%$search_query%' OR username LIKE '%$search_query%' OR password LIKE '%$search_query%'";
                                        }
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td class='align-middle text-center'><span class='text-secondary text-xs font-weight-bold'>" . $row['nama_petugas'] . "</span></td>";
                                                ...
                                                echo "<td class='align-middle text-center'>
                                                        <button class='btn btn-primary btn-sm mt-3' onclick='openEditPetugas(
                                                            \"" . $row['id_petugas'] . "\",
                                                            \"" . $row['nama_petugas'] . "\",
                                                            \"" . $row['alamat'] . "\",
                                                            \"" . $row['nomor_telpon'] . "\",
                                                ...
                                                echo "<td class='align-middle text-center'>
                                                        <button class='btn btn-danger btn-sm mt-3' onclick='deletePetugas(\"" . $row['id_petugas'] . "\")'>Hapus</button>
                                                    </td>";
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('tambahPetugas').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'admin/petugas/petugas_tambah.php', true);
                xhr.onload = function() {
                    // Sembunyikan elemen .loading setelah permintaan AJAX selesai
                    loding.style.display = 'none';

                    if (xhr.status === 200) {
                        // Tangani respons dari admin/petugas/petugas_tambah.php di sini
                        ...
                        if (response === 'success') {
                            ...
                            swal("Error", "Gagal menambahkan data Petugas", "error");
                        }
                    } else {
        ...
        function openEditPetugas(id_petugas, nama_petugas, alamat, nomor_telpon, username, password) {
            // Isi data ke dalam form edit
            document.getElementById('editid_petugas').value = id_petugas;
            document.getElementById('editnama_petugas').value = nama_petugas;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('editPetugas').addEventListener('submit', function(event) {
                event.preventDefault(); // Menghentikan aksi default form submit
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'admin/petugas/petugas_edit.php', true);
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (response === 'success') {
                            ...
                            swal({
                                title: "Berhasil!",
                                text: "Data petugas berhasil diedit",
                                icon: "success",
                                buttons: {
                                    confirm: {
                                        text: "OK",
                            ...
                            swal("Error", "Gagal mengedit data petugas", "error");
                        }
                    } else {
                        swal("Error", "Terjadi kesalahan saat mengirim data", "error");
                    }
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'admin/petugas/petugas_hapus.php', true);
                        ...
                        xhr.onload = function() {
                            ...
                            if (xhr.status === 200) {
                                var response = xhr.responseText;
                                if (response === 'success') {
                                    swal("Sukses!", "Data petugas berhasil dihapus.", "success")
                                        .then(() => {
                                            // Refresh halaman setelah penghapusan berhasil
                                            window.location.reload();
                                        });
                                } else {
                                    swal("Error", "Gagal menghapus data petugas.", "error");
                                }
                            } else {
                                swal("Error", "Terjadi kesalahan saat mengirim data.", "error");
                            }
        ...
        function selectOption(jumlah) {
            ...
            window.location.href = "admin_data_petugas?jumlah=" + jumlah;
        }
    </script>
