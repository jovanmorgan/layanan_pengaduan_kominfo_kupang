...
<head>
  ...
  <title>
    Data Alat petugas | Layanan Pengaduan Kominfo
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/petugas_data_alat">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="modal fade" id="modalAlat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form id="tambahAlat" action="admin/alat/alat_tambah.php">
            <div class="modal-body">
              <!-- Isi form untuk menambah data -->
              <div class="form-group">
                <label for="nama_alat">Nama Alat :</label>
                <input type="text" class="form-control" name="nama_alat" id="nama_alat" placeholder="Masukkan nama alat">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="datetime-local" class="form-control" name="waktu" id="waktu" placeholder="Masukkan waktu alat">
              </div>
              <div class="form-group">
    ...
    <!--Edit Modal -->
    <div class="modal fade" id="editModalAlat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <form id="editAlat" action="admin/alat/alat_edit.php">
            <div class="modal-body">
              <input type="text" class="d-none" name="id_alat" id="editid_alat">
              <!-- Isi form untuk menambah data -->
              <div class="form-group">
                <label for="nama_alat">Nama Alat :</label>
                <input type="text" class="form-control" name="nama_alat" id="editnama_alat" placeholder="Masukkan nama alat">
              </div>
              <div class="form-group">
                <label for="jumlah">Jumlah :</label>
              ...
              <div class="form-group">
                <label for="waktu">Waktu :</label>
                <input type="datetime-local" class="form-control" name="waktu" id="editwaktu" placeholder="Masukkan waktu alat">
              </div>
              <div class="form-group">
                <label for="deskripsi">Deskripsi :</label>
          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <div class="dropdown">
                ...
                <!-- Tombol tambah -->
                <button class="btn btn-primary font-weight-bold text-xs" data-toggle="modal" data-target="#modalAlat">
                  TAMBAH
                </button>
                <!-- Tombol alat_export -->
                ...
                // Query untuk mengambil jumlah data dengan status_petugas "baru"
                $sql = "SELECT COUNT(*) as jumlah_baru FROM topik_chat_petugas WHERE status_petugas = 'baru'";
                ...
                <div class="btn-with-badge">
                  ...
                  <?php else : ?>
                    <a href="peugas_chat" class="btn btn-info font-weight-bold text-xs">
                      LIHAT CHAT KE ADMIN <i class="fas fa-comments text-white text-sm opacity-10"></i>
                    </a>
                  <?php endif; ?>
                </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('tambahAlat').addEventListener('submit', function(event) {
        ...
        xhr.open('POST', 'admin/alat/alat_tambah.php', true);
        xhr.onload = function() {
          ...
          if (xhr.status === 200) {
            ...
            var responseData = response.split('|'); // Split respons untuk mendapatkan status dan nama alat
            ...
            } else if (responseStatus === 'data_tidak_lengkap') {
              swal("Error", "Data yang anda masukan belum lengkap", "error");
            } else if (responseStatus === 'data_alat_sudah_ada') {
    ...
    function kirimDataStatus() {
      ...
      xhr.open('POST', 'petugas/chat/update_status.php', true);
      ...
      xhr.onload = function() {
        if (xhr.status === 200) {
          ...
          if (response.message === 'Status updated successfully') {
            window.location.href = 'petugas_chat.php';
          } else {
    ...
    function openEditModal(id, nama, jmlh, wk, dsk) {
      // Isi data ke dalam form edit
      document.getElementById('editid_alat').value = id;
      document.getElementById('editnama_alat').value = nama;
      document.getElementById('editjumlah').value = jmlh;
      document.getElementById('editwaktu').value = wk;
      document.getElementById('editdeskripsi').value = dsk;
      $('#editModalAlat').modal('show');
    }

    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('editAlat').addEventListener('submit', function(event) {
        event.preventDefault(); // Menghentikan aksi default form submit
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'admin/alat/alat_edit.php', true);
        xhr.onload = function() {
          // Sembunyikan elemen .loading setelah permintaan AJAX selesai
          loding.style.display = 'none';
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            xhr.open('POST', 'admin/alat/alat_hapus.php', true);
    ...
    function selectOption(jumlah) {
      ...
      window.location.href = "petugas_data_alat?jumlah=" + jumlah;
    }
  </script>
