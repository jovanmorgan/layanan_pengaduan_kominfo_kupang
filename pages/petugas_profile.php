...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="sidenav-footer mx-3 ">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/petugas_profile">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        // Periksa apakah session id_petugas telah diset
        if (isset($_SESSION['id_petugas'])) {
            $id_petugas = $_SESSION['id_petugas'];

            // Query SQL untuk mengambil data admin berdasarkan id_petugas dari session
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <form id="editDataProfile" action="petugas/fp/data_fp.php" method="POST">
                                                    <input type="hidden" class="form-control" name="id_petugas" id="id_petugas" value="<?php echo $admin['id_petugas']; ?>">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="example-text-input" class="form-control-label">Nama</label>
                                                            <input class="form-control" type="text" name="nama_petugas" value="<?php echo $admin['nama_petugas']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                ...
                                                <div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
                                                    <a href="javascript:void(0)" onclick="document.getElementById('editFotoProfile').click()">
                                                        <?php if (!empty($admin['gambar'])) : ?>
                                                            <img src="petugas/fp/gambar/<?php echo $admin['gambar']; ?>" class="rounded-circle img-fluid border border-2 border-white">
                                                        <?php else : ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('editDataProfile').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'petugas/fp/data_fp.php', true);
                xhr.onload = function() {
                    // Sembunyikan elemen .loading setelah permintaan AJAX selesai
                    loding.style.display = 'none';
