...
<head>
    ...
    <title>Laporan Data Pengaduan Pelanggan</title>
    <!--     Fonts and icons     -->
                        ...
                        <div class="table-responsive p-0">
                            <table id="example" class="table align-items-center mb-0 display nowrap">
                                ...
                                <tbody>
                                    ...
                                    $query .= " WHERE status = 'Dibatalkan' OR status = 'Ditunda' OR status = 'Disetujui' OR status = 'Terkirim'";
                                    ...
                                    if (!empty($search_query)) {
                                        $query .= " WHERE nama_dinas LIKE '%$search_query%' OR alamat_dinas LIKE '%$search_query%' OR nomor_telpon LIKE '%$search_query%' OR waktu_pengaduan LIKE '%$search_query%'";
                                    }
