...
if (empty($nama_pemimpin) || empty($nomor_telpon) || empty($username) || empty($password)) {
...
$query = "INSERT INTO pemimpin (nama_pemimpin, nomor_telpon, username, password) 
        VALUES ('$nama_pemimpin', '$nomor_telpon', '$username', '$password')";
