...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id_topik_chat_petugas'])) {
        ...
        // Query untuk mengambil data id_admin berdasarkan id_topik_chat_petugas dari tabel topik_chat_petugas
        $query_admin = "SELECT id_admin FROM topik_chat_petugas WHERE id_topik_chat_petugas = '$id_topik_chat_petugas'";
        ...
        if (mysqli_num_rows($result_admin) > 0) {
            ...
            $query_tambah_chat = "INSERT INTO detail_chat_petugas (id_topik_chat_petugas, id_pengguna, pengguna, deskripsi, waktu) VALUES ('$id_topik_chat_petugas', '$id_admin', '$pengguna', '$deskripsi', NOW())";
            ...
            // Jika tidak ada data id_admin yang cocok dengan id_topik_chat_petugas yang diberikan, kirim respons ke JavaScript
            echo "failed";
        }
    } else {
