...
if (empty($nama_petugas) || empty($alamat) || empty($nomor_telpon) || empty($username) || empty($password)) {
...
$query_update_pemimpin = "UPDATE petugas SET nama_petugas = '$nama_petugas', alamat = '$alamat', nomor_telpon = '$nomor_telpon', username = '$username', password = '$password' WHERE id_petugas = '$id_petugas'";
