...
$query_update_pemimpin = "UPDATE pelanggan SET nama_dinas = '$nama_dinas', alamat = '$alamat', nomor_telpon = '$nomor_telpon', username = '$username', password = '$password' WHERE id_pelanggan = '$id_pelanggan'";
