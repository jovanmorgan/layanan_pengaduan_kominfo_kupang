...
<body class="g-sidenav-show   bg-gray-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Chat Ke Petugas</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Chat Ke Petugas</h6>
                </nav>
    ...
    <script>
        ...
        function tambahChat(id_topik_chat_petugas) {
            Swal.fire({
                title: 'Kirim Pesan?',
                text: 'Beri Tahu pelanggan Kendalah yang terjadi!',
                icon: 'chat', // Menggunakan ikon chat
                html: '<form id="myForm" action="admin/chat_petugas/chat.php" method="POST" style="font-size: 16px;">' +
                ...
                if (result.value === 'success') {
                    ...
                    xhrDetailChat.open('GET', 'admin/chat_petugas/cek_detail_chat.php?id_topik_chat_petugas=' + idTopikChatPetugas, true);
                    ...
                    xhrDetailWaktu.open('GET', 'admin/chat_petugas/cek_detail_waktu.php?id_topik_chat_petugas=' + idTopikChatPetugas, true);
        ...
        function editChat(id_topik_chat_petugas, id_detail_chat_petugas, topik, deskripsi) {
            Swal.fire({
                ...
                html: '<form id="myForm" action="admin/chat_petugas/edit_chat.php" method="POST" style="font-size: 16px;">' +
        ...
        function hapusChat(id_topik_chat_petugas) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var xhr = new XMLHttpRequest();
                    xhr.open('POST', 'admin/chat_petugas/hapus_chat.php', true);
        ...
        commentButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('GET', 'admin/chat_petugas/cek_detail_chat.php?id_topik_chat_petugas=' + idTopikChatPetugas, true);
                xhr.onload = function() {
                    if (xhr.status === 200) {
                ...
                xhrWaktu.open('GET', 'admin/chat_petugas/cek_detail_waktu.php?id_topik_chat_petugas=' + idTopikChatPetugas, true);
        ...
        function selectOption(jumlah) {
            ...
            window.location.href = "admin_chat_petugas?jumlah=" + jumlah;
        }
    </script>
    <style>
