...
if (empty($id_petugas) || empty($nama_petugas) || empty($nomor_telpon) || empty($alamat) || empty($deskripsi) || empty($username) || empty($password)) {
...
$check_query_petugas = "SELECT * FROM petugas WHERE username = '$username' AND id_petugas != '$id_petugas'";
...
$query_update_petugas = "UPDATE petugas SET nama_petugas = '$nama_petugas', nomor_telpon = '$nomor_telpon', username = '$username', password = '$password', deskripsi = '$deskripsi', alamat = '$alamat' WHERE id_petugas = '$id_petugas'";
