...
<head>
  ...
  <title>
    Home Admin | Layanan Pengaduan Kominfo
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="admin_home" target="_blank">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="../pages/admin_home">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="../pages/admin_home" style="text-decoration: none; color: inherit;">
            <div class="card">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="../pages/admin_profile" style="text-decoration: none; color: inherit;">
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="../pages/admin_pengaduan" style="text-decoration: none; color: inherit;">
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      $query_count .= " WHERE status = 'Dibatalkan' OR status = 'Ditunda' OR status = 'Disetujui' OR status = 'Terkirim'";
                  ...
                  <p class="mb-0 text-sm">
                    ...
                    data-data yang diadukan untuk ditinjau
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6">
          <a href="../pages/admin_data_petugas" style="text-decoration: none; color: inherit;">
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="../pages/admin_data_pelanggan" style="text-decoration: none; color: inherit;">
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      // Query SQL untuk menghitung jumlah data dalam tabel pelanggan
                      $query_count_pelanggan = "SELECT COUNT(*) AS total_pelanggan FROM pelanggan";
                      $result_count_pelanggan = mysqli_query($koneksi, $query_count_pelanggan);

                      if ($result_count_pelanggan) {
                        $row_count_pelanggan = mysqli_fetch_assoc($result_count_pelanggan);
                        $total_data_pelanggan = $row_count_pelanggan['total_pelanggan'];

                        echo "<h5 class='font-weight-bolder'>$total_data_pelanggan Data</h5>";
                      } else {
                        echo "<h5 class='font-weight-bolder'>Error</h5>";
                      }
                  ...
                  <p class="mb-0 text-sm">
                    <span class="text-success font-weight-bolder">Pelanggan :</span>
                    data-data dari para pelanggan
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="../pages/admin_data_penanganan" style="text-decoration: none; color: inherit;">
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
            ...
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      <p class="text-sm mb-0 text-uppercase font-weight-bold">Penggunaan</p>
                      <?php
                      include '../koneksi.php';
                  ...
                  <p class="mb-0 text-sm">
                    <span class="text-success font-weight-bolder">Penggunaan :</span>
