...
<head>
    ...
    <title>
        Laporan Pemimpin | Layanan Pengaduan Kominfo
    </title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="pemimpin_home" target="_blank">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link " href="../pages/pemimpin_home">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/pemimpin_laporan">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-chart-bar-32 text-warning text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Laporan Kendala</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="../pages/pemimpin_profile">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="../pages/pemimpin_logout">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Laporan Kendala</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Laporan Kendala</h6>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="pemimpin_profile" class="nav-link text-white font-weight-bold px-0">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h3 class="text-center">Laporan Kendalah</h3>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu d1" id="jumlahDropdown">
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Jenis Pengaduan</th>
                                            <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Jumlah Pengaduan</th>
                                            <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Export</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        $query = "SELECT 
                                                    jenis_pengaduan,
                                                    COUNT(jenis_pengaduan) AS jumlah_pengaduan
                                                FROM 
                                                    pengaduan";

                                        // Jika ada kata kunci pencarian, tambahkan klausa WHERE untuk mencocokkan jenis_pengaduan dengan kata kunci
                                        if (!empty($search_query)) {
                                            $query .= " WHERE jenis_pengaduan LIKE '%$search_query%'";
                                        }
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td class='align-middle text-center'><span class='text-secondary text-xs font-weight-bold'>" . $row['jumlah_pengaduan'] . "</span></td>";
                                                echo "<td class='align-middle text-center'><span class='text-secondary text-xs font-weight-bold'><a target='_blank' href='pemimpin/laporan/laporan_export?jenis_pengaduan=" . urlencode($row['jenis_pengaduan']) . "' class='btn btn-primary'>Export</a></span></td>";
                                                echo "</tr>";
...
<script>
    ...
    function selectOption(jumlah) {
        ...
        window.location.href = "admin_laporan?jumlah=" + jumlah;
    }
</script>
