...
<head>
    ...
    <title>
        Pemimpin Admin | Layanan Pengaduan Kominfo
    </title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/admin_data_pemimpin">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Pemimpin</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Pemimpin</h6>
                </nav>
        ...
        <!-- End Navbar -->
        <!-- Modal -->
        <div class="modal fade" id="tambahPemimpin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pemimpin</h5>
                    ...
                    <form id="tambahDP" action="admin/pemimpin/pemimpin_tambah.php">
                        <div class="modal-body">
                            <!-- Isi form untuk menambah data -->
                            <div class="form-group">
                                <label for="nama_pemimpin">Nama Pemimpin</label>
                                <input type="text" class="form-control" name="nama_pemimpin" id="nama_pemimpin" placeholder="Masukkan nama pemimpin">
                            </div>
                            <div class="form-group">
        ...
        <!--Edit Modal -->
        <div class="modal fade" id="editPemimpin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Data Pemimpin</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style=" border: none; background-color: #ffffff; font-size: 35px;">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="edittambahDP" action="admin/pemimpin/pemimpin_edit.php">
                        <div class="modal-body">
                            <input type="text" class="d-none" name="id_pemimpin" id="editid_pemimpin">
                            <!-- Isi form untuk menambah data -->
                            <div class="form-group">
                                <label for="nama_pemimpin">Nama Pemimpin</label>
                                <input type="text" class="form-control" name="nama_pemimpin" id="editnama_pemimpin" placeholder="Masukkan nama pemimpin">
                            </div>
                            <div class="form-group">
                                <label for="nomor_telpon">Nomor Telepon</label>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <div class="dropdown">
                                ...
                                <!-- Tombol tambah -->
                                <button class="btn btn-primary font-weight-bold text-xs" data-toggle="modal" data-target="#tambahPemimpin">
                                    TAMBAH
                                </button>
                                <!-- Tombol pemimpin_export -->
                                <a href="admin/pemimpin/pemimpin_export" target="_blank" class="btn btn-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                    EXPORT
                                </a>
                            </div>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        // Query SQL untuk mengambil data dari tabel pemimpin sesuai dengan jumlah yang dipilih
                                        $query = "SELECT * FROM pemimpin";
                                        ...
                                        if (!empty($search_query)) {
                                            $query .= " WHERE nama_pemimpin LIKE '%$search_query%' OR nomor_telpon LIKE '%$search_query%' OR username LIKE '%$search_query%' OR password LIKE '%$search_query%'";
                                        }
                                        // Balik urutan data untuk memunculkan yang paling baru di atas
                                        $query .= " ORDER BY id_pemimpin DESC";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td class='align-middle text-center'><span class='text-secondary text-xs font-weight-bold'>" . $row['nama_pemimpin'] . "</span></td>";
                                                ...
                                                echo "<td class='align-middle text-center'>
                                                        <button class='btn btn-danger btn-sm mt-3' onclick='deleteVideo(\"" . $row['id_pemimpin'] . "\")'>Hapus</button>
                                                    </td>";
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('tambahDP').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'admin/pemimpin/pemimpin_tambah.php', true);
                xhr.onload = function() {
                    // Sembunyikan elemen .loading setelah permintaan AJAX selesai
                    loding.style.display = 'none';

                    if (xhr.status === 200) {
                        // Tangani respons dari admin/pemimpin/pemimpin_tambah.php di sini
                        var response = xhr.responseText;
                        if (response === 'success') {
                            $('#tambahPemimpin').modal('hide');
                            swal({
                                title: "Berhasil!",
                                text: "Data pemimpin berhasil ditambahkan",
                                icon: "success",
                                buttons: {
                                    confirm: {
                                        text: "OK",
                            ...
                            swal("Error", "Gagal menambahkan data Pemimpin", "error");
                        }
                    } else {
        ...
        function openEditModal(id, nama, nomor, username, password) {
            // Isi data ke dalam form edit
            document.getElementById('editid_pemimpin').value = id;
            document.getElementById('editnama_pemimpin').value = nama;
            document.getElementById('editnomor_telpon').value = nomor; // Mengubah type menjadi nomor
            document.getElementById('editusername').value = username; // Mengubah durasi menjadi username
            document.getElementById('editpassword').value = password; // Mengubah alamat menjadi password
            $('#editPemimpin').modal('show');
        }

        // logika untuk mengedit data data pemimpin
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('edittambahDP').addEventListener('submit', function(event) {
                event.preventDefault(); // Menghentikan aksi default form submit
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'admin/pemimpin/pemimpin_edit.php', true);
                xhr.onload = function() {
                    // Sembunyikan elemen .loading setelah permintaan AJAX selesai
                    loding.style.display = 'none';
                    ...
                    if (xhr.status === 200) {
                        ...
                        var response = xhr.responseText;
                        if (response === 'success') {
                            $('#editPemimpin').modal('hide');
                            swal({
                                title: "Berhasil!",
                                text: "Data pemimpin berhasil diedit",
                                icon: "success",
                                buttons: {
                                    confirm: {
                                        text: "OK",
                            ...
                            swal("Error", "Gagal mengedit data Pemimpin", "error");
                        }
                    } else {
                        swal("Error", "Terjadi kesalahan saat mengirim data", "error");
                    }
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'admin/pemimpin/pemimpin_hapus.php', true);
                        ...
                        xhr.onload = function() {
                            ...
                            if (xhr.status === 200) {
                                var response = xhr.responseText;
                                if (response === 'success') {
                                    swal("Sukses!", "Data pemimpin berhasil dihapus.", "success")
                                        .then(() => {
                                            // Refresh halaman setelah penghapusan berhasil
                                            window.location.reload();
                                        });
                                } else {
                                    swal("Error", "Gagal menghapus data pemimpin.", "error");
                                }
                            } else {
                                swal("Error", "Terjadi kesalahan saat mengirim data.", "error");
                            }
        ...
        function selectOption(jumlah) {
            ...
            window.location.href = "admin_data_pemimpin?jumlah=" + jumlah;
        }
    </script>
