...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/admin_data_alat_digunakan">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <script>
        ...
        function EditStatus(id_alat_keluar, id_alat, status, jumlah) {
            Swal.fire({
                ...
                if (willStatus.isConfirmed) {
                    var xhr = new XMLHttpRequest();
                    var loding = document.querySelector('.loading'); // Menambahkan ini untuk mendapatkan elemen loading

                    loding.style.display = 'flex'; // Tampilkan loading

                    xhr.open('POST', 'admin/alat_keluar/alat_status.php', true);
                    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                    xhr.onload = function() {
                        loding.style.display = 'none'; // Sembunyikan loading setelah selesai
                        ...
                        if (xhr.status === 200) {
                            ...
                            if (response.startsWith('success')) {
                                ...
                                var namaAlat = data[1];
                                var stokAlat = data[2];
                                Swal.fire("Error", "Stok " + namaAlat + " tidak cukup, stok " + namaAlat + " tersisa: " + stokAlat, "error");
                            } else {
                    ...
                    xhr.send("id_alat_keluar=" + id_alat_keluar + "&id_alat=" + id_alat + "&status=" + status + "&jumlah=" + jumlah);
                } else {
        ...
        function KirimPesan(id_admin, id_alat, id_pengaduan) {
            Swal.fire({
                    ...
                    icon: 'info',
                    html: '<form id="myForm" action="admin/alat_keluar/kirim_pesan.php" method="POST" style="font-size: 16px;">' +
        ...
        function selectOption(jumlah) {
            ...
            window.location.href = "admin_data_alat_digunakan?jumlah=" + jumlah;
        }
    </script>
    <style>
